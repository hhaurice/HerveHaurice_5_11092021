...
function displayItem(data) {
    ...
    const product = document.getElementById("produit");

    const productCaption = document.createElement("img");
...
function updateCart() {
    ...
    const cartCount = document.createElement("span"); // create span element 
